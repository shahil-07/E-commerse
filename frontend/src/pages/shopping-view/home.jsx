...
const categoriesWithIcon = [
  ...
  { id: "computer-accessories", label: "Computer Accessories", icon: Laptop },
  { id: "home-appliances", label: "Home Appliances", icon: Lamp },
];
...
const brandsWithIcon = [
  ...
  { id: "hp", label: "HP", icon: Monitor },
  { id: "loreal", label: "L'Oreal", icon: Sparkles },
];
